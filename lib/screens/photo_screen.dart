...
Future<File> deleteThis() async {
  ...
  final String dirPath = '${extDir.path}/photos';
...
class PhotoHome extends StatefulWidget {
  ...
  PhotoHome(this.cameras);
  @override
  _PhotoHomeState createState() {
    return _PhotoHomeState(cameras);
  }
}
...
class _PhotoHomeState extends State<PhotoHome> with WidgetsBindingObserver {
  CameraController controller;
  String imagePath;
  final List<CameraDescription> cameras;
  _PhotoHomeState(this.cameras);
