...
class TestClassifier extends StatefulWidget {
  @override
  _TestClassifierState createState() => new _TestClassifierState();
}

class _TestClassifierState extends State<TestClassifier> {
  File _image;
  List _recognitions;
